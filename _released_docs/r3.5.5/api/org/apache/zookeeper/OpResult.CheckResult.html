...
<html lang="en">
<head>
<!-- Generated by javadoc (1.8.0_201) on Fri May 03 05:07:43 PDT 2019 -->
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>OpResult.CheckResult (Apache ZooKeeper - Server 3.5.5 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="OpResult.CheckResult (Apache ZooKeeper - Server 3.5.5 API)";
        }
    }
    catch(err) {
    }
