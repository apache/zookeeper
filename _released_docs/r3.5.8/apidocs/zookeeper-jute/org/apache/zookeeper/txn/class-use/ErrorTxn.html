...
<title>Uses of Class org.apache.zookeeper.txn.ErrorTxn (Apache ZooKeeper - Jute 3.5.8 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class org.apache.zookeeper.txn.ErrorTxn (Apache ZooKeeper - Jute 3.5.8 API)";
        }
    }
    catch(err) {
    }
