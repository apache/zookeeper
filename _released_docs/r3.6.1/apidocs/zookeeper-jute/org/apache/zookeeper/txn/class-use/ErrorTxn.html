...
<title>Uses of Class org.apache.zookeeper.txn.ErrorTxn (Apache ZooKeeper - Jute 3.6.1 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class org.apache.zookeeper.txn.ErrorTxn (Apache ZooKeeper - Jute 3.6.1 API)";
        }
    }
    catch(err) {
    }
