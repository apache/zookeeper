...
<html lang="en">
<head>
<!-- Generated by javadoc (1.8.0_242) on Tue Apr 21 17:01:11 CEST 2020 -->
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>KeeperException.Code (Apache ZooKeeper - Server 3.6.1 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="KeeperException.Code (Apache ZooKeeper - Server 3.6.1 API)";
        }
    }
    catch(err) {
    }
