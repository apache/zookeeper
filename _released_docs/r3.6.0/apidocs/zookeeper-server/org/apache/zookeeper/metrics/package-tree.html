...
<title>org.apache.zookeeper.metrics Class Hierarchy (Apache ZooKeeper - Server 3.6.0 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="org.apache.zookeeper.metrics Class Hierarchy (Apache ZooKeeper - Server 3.6.0 API)";
        }
    }
    catch(err) {
    }
