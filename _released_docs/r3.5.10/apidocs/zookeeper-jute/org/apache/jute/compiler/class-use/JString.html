...
<title>Uses of Class org.apache.jute.compiler.JString (Apache ZooKeeper - Jute 3.5.10 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class org.apache.jute.compiler.JString (Apache ZooKeeper - Jute 3.5.10 API)";
        }
    }
    catch(err) {
    }
