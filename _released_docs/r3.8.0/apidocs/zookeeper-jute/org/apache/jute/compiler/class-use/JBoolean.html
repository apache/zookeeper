...
<html lang="en">
<head>
<!-- Generated by javadoc (1.8.0_282) on Fri Feb 25 08:48:50 UTC 2022 -->
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Uses of Class org.apache.jute.compiler.JBoolean (Apache ZooKeeper - Jute 3.8.0 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class org.apache.jute.compiler.JBoolean (Apache ZooKeeper - Jute 3.8.0 API)";
        }
    }
    catch(err) {
    }
