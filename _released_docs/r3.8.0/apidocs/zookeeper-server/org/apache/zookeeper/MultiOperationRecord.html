...
<html lang="en">
<head>
<!-- Generated by javadoc (1.8.0_282) on Fri Feb 25 08:50:50 UTC 2022 -->
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>MultiOperationRecord (Apache ZooKeeper - Server 3.8.0 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="MultiOperationRecord (Apache ZooKeeper - Server 3.8.0 API)";
        }
    }
    catch(err) {
    }
