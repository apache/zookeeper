import{j as e}from"./chunk-EPOLDU6W-BACfhBcx.js";let r=`## The Four Letter Words
...
the AdminServer is disabled.`},{heading:"configuring-adminserver-for-ssltls",content:"Generating the keystore.jks and truststore.jks which can be found in the Quorum TLS."},{heading:"configuring-adminserver-for-ssltls",content:"Add the following configuration settings to the zoo.cfg config file:"},{heading:"configuring-adminserver-for-ssltls",content:"Verify that the following entries in the logs can be seen:"},{heading:"configuring-adminserver-for-ssltls",content:"Available commands include:"},{heading:"configuring-adminserver-for-ssltls",content:`connection_stat_reset/crst:
Reset all client connection statistics.
No new fields returned.`},{heading:"configuring-adminserver-for-ssltls",content:`configuration/conf/config :
Print basic details about serving configuration, e.g.
client port, absolute path to data directory.`},{heading:"configuring-adminserver-for-ssltls",content:`connections/cons :
Information on client connections to server.
Note, depending on the number of client connections this operation may be expensive
(i.e. impact server performance).
Returns "connections", a list of connection info objects.`},{heading:"configuring-adminserver-for-ssltls",content:`hash:
Txn digests in the historical digest list.
One is recorded every 128 transactions.
Returns "digests", a list to transaction digest objects.`},{heading:"configuring-adminserver-for-ssltls",content:`dirs :
Information on logfile directory and snapshot directory
size in bytes.
Returns "datadir_size" and "logdir_size".`},{heading:"configuring-adminserver-for-ssltls",content:`dump :
Information on session expirations and ephemerals.
Note, depending on the number of global sessions and ephemerals
this operation may be expensive (i.e. impact server performance).
Returns "expiry_time_to_session_ids" and "session_id_to_ephemeral_paths" as maps.`},{heading:"configuring-adminserver-for-ssltls",content:`environment/env/envi :
All defined environment variables.
Returns each as its own field.`},{heading:"configuring-adminserver-for-ssltls",content:`get_trace_mask/gtmk :
The current trace mask. Read-only version of set_trace_mask.
See the description of the four letter command stmk for
more details.
Returns "tracemask".`},{heading:"configuring-adminserver-for-ssltls",content:`initial_configuration/icfg :
Print the text of the configuration file used to start the peer.
Returns "initial_configuration".`},{heading:"configuring-adminserver-for-ssltls",content:`is_read_only/isro :
A true/false if this server is in read-only mode.
Returns "read_only".`},{heading:"configuring-adminserver-for-ssltls",content:`last_snapshot/lsnp :
Information of the last snapshot that zookeeper server has finished saving to disk.
If called during the initial time period between the server starting up
and the server finishing saving its first snapshot, the command returns the
information of the snapshot read when starting up the server.
Returns "zxid" and "timestamp", the latter using a time unit of seconds.`},{heading:"configuring-adminserver-for-ssltls",content:`leader/lead :
If the ensemble is configured in quorum mode then emits the current leader
status of the peer and the current leader location.
Returns "is_leader", "leader_id", and "leader_ip".`},{heading:"configuring-adminserver-for-ssltls",content:`monitor/mntr :
Emits a wide variety of useful info for monitoring.
Includes performance stats, information about internal queues, and
summaries of the data tree (among other things).
Returns each as its own field.`},{heading:"configuring-adminserver-for-ssltls",content:`observer_connection_stat_reset/orst :
Reset all observer connection statistics. Companion command to observers.
No new fields returned.`},{heading:"configuring-adminserver-for-ssltls",content:`restore/rest :
Restore database from snapshot input stream on the current server.
Returns the following data in response payload:
"last_zxid": String
Note: this API is rate-limited (once every 5 mins by default) to protect the server
from being over-loaded.`},{heading:"configuring-adminserver-for-ssltls",content:`ruok :
No-op command, check if the server is running.
A response does not necessarily indicate that the
server has joined the quorum, just that the admin server
is active and bound to the specified port.
No new fields returned.`},{heading:"configuring-adminserver-for-ssltls",content:`set_trace_mask/stmk :
Sets the trace mask (as such, it requires a parameter).
Write version of get_trace_mask.
See the description of the four letter command stmk for
more details.
Returns "tracemask".`},{heading:"configuring-adminserver-for-ssltls",content:`server_stats/srvr :
Server information.
Returns multiple fields giving a brief overview of server state.`},{heading:"configuring-adminserver-for-ssltls",content:`snapshot/snap :
Takes a snapshot of the current server in the datadir and stream out data.
Optional query parameter:
"streaming": Boolean (defaults to true if the parameter is not present)
Returns the following via Http headers:
...
Note: this API is rate-limited (once every 5 mins by default) to protect the server
from being over-loaded.`},{heading:"configuring-adminserver-for-ssltls",content:`stats/stat :
Same as server_stats but also returns the "connections" field (see connections
for details).
Note, depending on the number of client connections this operation may be expensive
(i.e. impact server performance).`},{heading:"configuring-adminserver-for-ssltls",content:`stat_reset/srst :
Resets server statistics. This is a subset of the information returned
by server_stats and stats.
No new fields returned.`},{heading:"configuring-adminserver-for-ssltls",content:`observers/obsr :
Information on observer connections to server.
Always available on a Leader, available on a Follower if its
acting as a learner master.
Returns "synced_observers" (int) and "observers" (list of per-observer properties).`},{heading:"configuring-adminserver-for-ssltls",content:`system_properties/sysp :
All defined system properties.
Returns each as its own field.`},{heading:"configuring-adminserver-for-ssltls",content:`voting_view :
Provides the current voting members in the ensemble.
Returns "current_config" as a map.`},{heading:"configuring-adminserver-for-ssltls",content:`watches/wchc :
Watch information aggregated by session.
Note, depending on the number of watches this operation may be expensive
(i.e. impact server performance).
Returns "session_id_to_watched_paths" as a map.`},{heading:"configuring-adminserver-for-ssltls",content:`watches_by_path/wchp :
Watch information aggregated by path.
Note, depending on the number of watches this operation may be expensive
(i.e. impact server performance).
Returns "path_to_session_ids" as a map.`},{heading:"configuring-adminserver-for-ssltls",content:`watch_summary/wchs :
Summarized watch information.
Returns "num_total_watches", "num_paths", and "num_connections".`},{heading:"configuring-adminserver-for-ssltls",content:`zabstate :
The current phase of Zab protocol that peer is running and whether it is a
voting member.
Peers can be in one of these phases: ELECTION, DISCOVERY, SYNCHRONIZATION, BROADCAST.
Returns fields "voting" and "zabstate".`}],headings:[{id:"the-four-letter-words",content:"The Four Letter Words"},{id:"the-adminserver",content:"The AdminServer"},{id:"configuring-adminserver-for-ssltls",content:"Configuring AdminServer for SSL/TLS"}]};const d=[{depth:2,url:"#the-four-letter-words",title:e.jsx(e.Fragment,{children:"The Four Letter Words"})},{depth:2,url:"#the-adminserver",title:e.jsx(e.Fragment,{children:"The AdminServer"})},{depth:2,url:"#configuring-adminserver-for-ssltls",title:e.jsx(e.Fragment,{children:"Configuring AdminServer for SSL/TLS"})}];function t(s){const n={a:"a",code:"code",em:"em",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"the-four-letter-words",children:"The Four Letter Words"}),`
...
Returns fields "voting" and "zabstate".`]}),`
`]}),`
`]})]})}function h(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{r as _markdown,h as default,a as extractedReferences,o as frontmatter,l as structuredData,d as toc};
