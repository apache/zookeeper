...
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:"Credit:"})," This issue was discovered by Lyon Yang (@l0Op3r)."]})]})}function o(n={}){const{wrapper:r}=n.components||{};return r?e.jsx(r,{...n,children:e.jsx(i,{...n})}):i(n)}function c(){return e.jsx(t,{Content:o,className:"mt-12"})}function f({}){return[{title:"Security - Apache ZooKeeper"},{name:"description",content:"How to report security vulnerabilities and review known CVEs for Apache ZooKeeper."}]}const m=s(function(){return e.jsx(c,{})});export{m as default,f as meta};
