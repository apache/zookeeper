...
`,e.jsxs(r.p,{children:["ZooKeeper is a coordination service intended for use inside a trusted network, not exposed directly to the Internet. The ",e.jsx(r.a,{href:"https://zookeeper.apache.org/doc/current/zookeeperAdmin.html",children:"Admin Guide"}),' states it plainly: "A ZooKeeper ensemble is expected to operate in a trusted computing environment. It is thus recommended deploying ZooKeeper behind a firewall." A fresh ensemble ships with no transport encryption, no peer authentication, and world-readable/writable znodes. Hardening is a shared responsibility between the ZooKeeper project and the operator.']}),`
...
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:"References:"})," ",e.jsx(r.a,{href:"https://issues.apache.org/jira/browse/ZOOKEEPER-1045",children:"ZOOKEEPER-1045"})," · ",e.jsx(r.a,{href:"https://cwiki.apache.org/confluence/display/ZOOKEEPER/Server-Server+mutual+authentication",children:"Server-Server mutual authentication"})," · ",e.jsx(r.a,{href:"https://zookeeper.apache.org/doc/current/zookeeperAdmin.html",children:"ZooKeeper Admin Guide"})]}),`
`,e.jsx(r.hr,{}),`
...
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:"Credit:"})," This issue was discovered by Lyon Yang (@l0Op3r)."]})]})}function o(n={}){const{wrapper:r}=n.components||{};return r?e.jsx(r,{...n,children:e.jsx(i,{...n})}):i(n)}function c(){return e.jsx(t,{Content:o,className:"mt-12"})}function u({}){return[{title:"Security - Apache ZooKeeper"},{name:"description",content:"How to report security vulnerabilities and review known CVEs for Apache ZooKeeper."}]}const x=s(function(){return e.jsx(c,{})});export{x as default,u as meta};
