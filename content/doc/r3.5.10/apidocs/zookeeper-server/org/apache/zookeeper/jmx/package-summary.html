...
<title>org.apache.zookeeper.jmx (Apache ZooKeeper - Server 3.5.10 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="org.apache.zookeeper.jmx (Apache ZooKeeper - Server 3.5.10 API)";
        }
    }
    catch(err) {
    }
