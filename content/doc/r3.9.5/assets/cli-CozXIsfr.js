import{j as e}from"./chunk-EPOLDU6W-CDTnuKF9.js";let a=`## Connecting
...
Quit the CLI. Both \`quit\` and \`exit\` work.
...
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"exit"})}),`
...
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"printwatches is on"})})]})})}),`
`,e.jsx(n.h2,{id:"quit-or-exit",children:"quit (or exit)"}),`
`,e.jsxs(n.p,{children:["Quit the CLI. Both ",e.jsx(n.code,{children:"quit"})," and ",e.jsx(n.code,{children:"exit"})," work."]}),`
