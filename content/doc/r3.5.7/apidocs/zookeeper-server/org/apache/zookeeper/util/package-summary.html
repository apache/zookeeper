...
<title>org.apache.zookeeper.util (Apache ZooKeeper - Server 3.5.7 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="org.apache.zookeeper.util (Apache ZooKeeper - Server 3.5.7 API)";
        }
    }
    catch(err) {
    }
