...
<title>Uses of Class org.apache.zookeeper.ClientCnxn (Apache ZooKeeper - Server 3.7.0 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class org.apache.zookeeper.ClientCnxn (Apache ZooKeeper - Server 3.7.0 API)";
        }
    }
    catch(err) {
    }
