...
<title>Uses of Class org.apache.jute.compiler.JBoolean (Apache ZooKeeper - Jute 3.6.0 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class org.apache.jute.compiler.JBoolean (Apache ZooKeeper - Jute 3.6.0 API)";
        }
    }
    catch(err) {
    }
