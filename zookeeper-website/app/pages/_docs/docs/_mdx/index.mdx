---
title: "Overview"
description: "Official Apache ZooKeeper documentation covering installation, configuration, the data model, client APIs, administration, and operations."
---
...
![ZooKeeper Service](/docs-images/zkservice.jpg)
...
![ZooKeeper's Hierarchical Namespace](/docs-images/zknamespace.jpg)
...
- _create_ : creates a node at a location in the tree
- _delete_ : deletes a node
- _exists_ : tests if a node exists at a location
- _get data_ : reads the data from a node
- _set data_ : writes data to a node
...
![ZooKeeper Components](/docs-images/zkcomponents.jpg)
...
![ZooKeeper Throughput as the Read-Write Ratio Varies](/docs-images/zkperfRW-3.2.jpg)
...
![Reliability in the Presence of Errors](/docs-images/zkperfreliability.jpg)
