---
title: "JMX"
description: "How to enable and use JMX monitoring and management for ZooKeeper ensembles, including starting with JMX, connecting via jconsole, and a full MBean reference for replicated and standalone servers."
---
...
monitoring and management of the instance. See _bin/zkServer.sh_ for one
...
to the running server. For this example we will use Sun's _jconsole_.
...
start _jconsole_, which typically resides in _JDK_HOME/bin/jconsole_.
...
### Logback MBeans _(new in 3.8.0)_
