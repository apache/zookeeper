    ...
    public class ChrootTests : AbstractZooKeeperTests
    {
        ...
        public void testChrootSynchronous()
        {
            ...
            using (ZooKeeper zk2 = CreateClient(ch1))
            {
                ...
                bDatas = zk1.GetData(ch1Ch2, false, null);
                Assert.AreEqual("2", Encoding.UTF8.GetString(bDatas));
                bDatas = zk2.GetData(ch2, false, null);
                Assert.AreEqual("2", Encoding.UTF8.GetString(bDatas));
                ...
                zk1.Delete(ch1, -1);
                Assert.IsNull(zk1.Exists(ch1, false));
                Assert.IsNull(zk1.Exists(ch1Ch2, false));
                Assert.IsNull(zk2.Exists(ch2, false));
            }
