...
import org.apache.zookeeper.client.ZooKeeperSaslClient.ClientCallbackHandler;
...
public final class SecurityUtils {
    ...
    public static SaslClient createSaslClient(final Subject subject,
            ...
            final String serverName, final Logger LOG) throws SaslException {
        ...
        if (subject.getPrincipals().isEmpty()) {
            ...
            saslClient = Sasl.createSaslClient(mechs, username, protocol,
                    serverName, null, new ClientCallbackHandler(password));
            return saslClient;
        } else { // GSSAPI.
