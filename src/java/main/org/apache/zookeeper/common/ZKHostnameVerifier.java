 ...
 * @since 8-Dec-2006
 */
public interface ZKHostnameVerifier extends HostnameVerifier {
     ...
     * "a.b.foo.com".
     */
    public final static ZKHostnameVerifier DEFAULT =
     ...
     */
    public final static ZKHostnameVerifier DEFAULT_AND_LOCALHOST =
            new AbstractVerifier() {
                public final void check(final String[] hosts, final String[] cns,
                                        final String[] subjectAlts)
                        throws SSLException {
     ...
     * such as "a.b.foo.com".
     */
    public final static ZKHostnameVerifier STRICT =
            new AbstractVerifier() {
     ...
     */
    public final static ZKHostnameVerifier STRICT_IE6 =
            new AbstractVerifier() {
                public final void check(final String[] host, final String[] cns,
                                        final String[] subjectAlts)
                        throws SSLException {
     ...
     */
    public final static ZKHostnameVerifier ALLOW_ALL =
            new AbstractVerifier() {
                public final void check(final String[] host, final String[] cns,
                                        final String[] subjectAlts) {
    ...
    abstract class AbstractVerifier implements ZKHostnameVerifier {
