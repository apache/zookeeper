...
public class QuorumAuth {
    ...
    public static final String QUORUM_SERVER_AUTH_REQUIRED = "quorum.auth.serverRequireSasl";
    public static final String QUORUM_CLIENT_AUTH_ENABLED = "quorum.auth.clientEnableSasl";
    ...
    public static final String QUORUM_CLIENT_LOGIN_CONTEXT = "quorum.auth.client.loginContext";
    public static final String QUORUM_CLIENT_LOGIN_CONTEXT_DFAULT_VALUE = "QuorumClient";

    public static final String QUORUM_SERVER_LOGIN_CONTEXT = "quorum.auth.server.loginContext";
    public static final String QUORUM_SERVER_LOGIN_CONTEXT_DFAULT_VALUE = "QuorumServer";
    ...
    // this is negative, so that if a client that does auth, connects to a
    // server that doesn't do auth, it'll think the auth packet is
