 ...
 *
 * Branch : trunk
 * Github Revision: d08fc9aca807af5a240f5e1904d9c0ba027196b8
 */
public class MiniKdcTest extends KerberosSecurityTestcase {
    ...
    public void testKeytabGen() throws Exception {
        ...
        // here principals use \ instead of / because
        // org.apache.directory.server.kerberos.shared.keytab.KeytabDecoder.getPrincipalName(IoBuffer buffer)
        // use when generates principal
        Assert.assertEquals(new HashSet<String>(Arrays.asList("foo\\bar@" + kdc.getRealm(),
                        "bar\\foo@" + kdc.getRealm())), principals);
    }
