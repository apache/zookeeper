...
namespace org.apache.zookeeper {
    ...
    public class ZooKeeper {
        ...
        /// <exception cref="ArgumentException">when <see cref="connectstring"/> parsed or resolved to an empty list. also when given chroot is invalid"/></exception>
        ...
        public ZooKeeper(string connectString, int sessionTimeout, Watcher watcher,
            ...
            LOG.info("Initiating client connection, connectString=" + connectString
                     ...
                     + " watcher=" + watcher
                     + " sessionId=" + sessionId.ToString("X")
                     + " sessionPasswd="
            ...
            watchManager.defaultWatcher = new WatcherDelegate(@event =>
            {
                ...
                else if (connectedTask.WaitAsync().IsCompleted) 
                    connectedTask.Reset();
        ...
        public async Task closeAsync() 
        {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("Closing session: 0x" + getSessionId().ToString("x"));
            }
            ...
            LOG.info("Session: 0x" + getSessionId().ToString("x") + " closed");
        }
        ...
        /// <exception cref="ArgumentException">when <see cref="path"/> is invalid</exception>
        ...
        /// which exactly matches the order of the <see cref="ops"/> input
        /// operations.</returns>
        ...
        #region Using        
        /// <summary>
        /// Creates a ZK with <see cref="ZooKeeper(string,int,Watcher,long,byte[],bool)"/> and pass it to <see cref="zkMethod"/>
        /// </summary>
        ...
        /// <summary>
        /// Creates a ZK with <see cref="ZooKeeper(string,int,Watcher,bool)"/> and pass it to <see cref="zkMethod"/>
        /// </summary>
