...
echo $CLASSPATH
java -Dlog4j.configurationFile=org/apache/zookeeper/graph/log4j2.xml -Xdebug -Xrunjdwp:transport=dt_socket,address=4444,server=y,suspend=n -cp $CLASSPATH org.apache.zookeeper.graph.LogServer $*
