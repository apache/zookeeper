...
public class PrometheusMetricsProvider implements MetricsProvider {
    ...
    private int numWorkerThreads = numCores;
    ...
    public void configure(Properties configuration) throws MetricsProviderLifeCycleException {
        ...
        this.numWorkerThreads = Integer.parseInt(
                configuration.getProperty(NUM_WORKER_THREADS, String.valueOf(numCores)));
        this.maxQueueSize = Integer.parseInt(
                configuration.getProperty(MAX_QUEUE_SIZE, String.valueOf(Integer.MAX_VALUE)));
