...
public class DataTreeTotCodeFinalTest {
    ...
    @Nested
    @DisplayName("Tree Hierarchy Tests")
    class TreeHierarchyTests {
        ...
        @Test
        @DisplayName("Identify special ZooKeeper paths")
    ...
    @Nested
    @DisplayName("Session and Ephemeral Tests")
    class SessionAndEphemeralTests {
        ...
        @Test
        @DisplayName("Clean up ephemeral nodes upon session kill")
