...
public class PersistentRecursiveWatcherWithCreateOrSetTest extends ClientBase {
    private static final Logger LOG = LoggerFactory.getLogger(PersistentRecursiveWatcherWithCreateOrSetTest.class);
    ...
    private void internalTestBasic(ZooKeeper zk) throws KeeperException, InterruptedException {
        zk.createOrSet("/a", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
        zk.createOrSet("/a/b", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
        zk.createOrSet("/a/b/c", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
        zk.createOrSet("/a/b/c/d", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
        zk.createOrSet("/a/b/c/d/e", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
        zk.createOrSet("/a/b/c/d/e", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
    ...
    public void testRootWatcher()
        ...
        try (ZooKeeper zk = createClient(new CountdownWatcher(), hostPort)) {
            ...
            zk.createOrSet("/a", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
            zk.createOrSet("/a/b", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
            zk.createOrSet("/b", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
            zk.createOrSet("/b/c", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT,-1,new Stat());
