...
public class StatWithCreateOrSetTest extends ClientBase {
    ...
    public void testBasic() throws IOException, KeeperException, InterruptedException {
        String name = "/foo";
        zk.createOrSet(name, name.getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT, -1, new Stat());
    ...
    public void testChild() throws IOException, KeeperException, InterruptedException {
        ...
        zk.createOrSet(childname, childname.getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL, -1, new Stat());
    ...
    public void testDataSizeChange() throws IOException, KeeperException, InterruptedException {
        ...
        zk.createOrSet(name, (name + name).getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT, -1, new Stat());
