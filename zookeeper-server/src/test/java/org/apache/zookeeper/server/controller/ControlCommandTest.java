...
public class ControlCommandTest {
    ...
    public void verifyGeneratedUri() {
        Assert.assertEquals(
                "command/ping",
                ControlCommand.createCommandUri(ControlCommand.Action.PING, null)
                        .toLowerCase());
        Assert.assertEquals(
                "command/ping",
                ControlCommand.createCommandUri(ControlCommand.Action.PING, "").toLowerCase());
        Assert.assertEquals(
                "command/closeconnection/1234",
                ControlCommand.createCommandUri(ControlCommand.Action.CLOSECONNECTION, "1234")
                        .toLowerCase());
    }
