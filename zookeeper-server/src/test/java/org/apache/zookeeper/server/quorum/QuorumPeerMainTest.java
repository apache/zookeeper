...
public class QuorumPeerMainTest extends QuorumPeerTestBase {
    ...
    public void testUpdatingEpoch() throws Exception {
        ...
        for (int i = 0; i < numServers; i++) {
            ...
            LOG.info("Validating current epoch: " + dataDir);
        ...
        assertTrue("Found a valid follower",
        ...
        follower.start();
        assertTrue(follower.mainFailed.await(10, TimeUnit.SECONDS));
        ...
        waitForAll(servers.zk, States.CONNECTED);
        assertNotNull("Make sure the server started with acceptEpoch",
                follower.main.quorumPeer.getActiveServer());
        assertFalse("updatingEpoch file should get deleted",
