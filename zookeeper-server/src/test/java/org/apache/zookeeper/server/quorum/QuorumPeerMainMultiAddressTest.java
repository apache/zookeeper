...
public class QuorumPeerMainMultiAddressTest extends QuorumPeerTestBase {
    ...
    public void shouldReconfigIncrementallyByAddingMoreAddresses() throws Exception {
        ...
        QuorumServerConfigBuilder newQuorumConfig =
                new QuorumServerConfigBuilder(initialQuorumConfig).addNewServerAddress(FIRST_SERVER);
    ...
    public void shouldFailToReconfigWithMultipleAddressesWhenFeatureIsDisabled() throws Exception {
        ...
        try {
            ReconfigTest.reconfig(zkAdmin, newQuorumConfig.buildAsStringList(), null, null, -1);
            fail(
                    "Reconfig succeeded with multiple addresses without exception when the MultiAddress feature is disabled");
    ...
    private void checkIfZooKeeperQuorumWorks(QuorumServerConfigBuilder builder)
    ...
    private ZooKeeper connectToZkServer(QuorumServerConfigBuilder builder, int serverId)
