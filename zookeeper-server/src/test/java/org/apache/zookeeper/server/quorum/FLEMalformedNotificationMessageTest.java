...
public class FLEMalformedNotificationMessageTest extends ZKTestCase {
    ...
    public void setUp() throws Exception {
         ...
         * Start server 0
         */
        peerRunningLeaderElection = new QuorumPeer(peers, tmpdir[0], tmpdir[0], port[0], ElectionAlgorithmTypeEnum.FastLeaderElection, 0, 1000, 2, 2, 2);
    ...
    void startMockServer(int sid) throws IOException {
        QuorumPeer peer = new QuorumPeer(peers, tmpdir[sid], tmpdir[sid], port[sid], ElectionAlgorithmTypeEnum.FastLeaderElection, sid, 1000, 2, 2, 2);
