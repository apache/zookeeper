...
public class ByteBufferInputStreamTest extends ZKTestCase {
    ...
    @BeforeClass
    public static void setUpDataBytes() throws Exception {
    ...
    @Test
    public void testReadArrayOffsetLength_HitEndOfStream()
        throws Exception {
    ...
    @Test
    public void testReadArrayOffsetLength_AtEndOfStream()
        throws Exception {
        for (int i = 0; i < DATA_BYTES.length; i++) {
            in.read();
        }
