...
public class DataTree_ESTest_3min_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DataTree_ESTest_3min_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, DataTree_ESTest_3min_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.zookeeper.DigestWatcher", false, DataTree_ESTest_3min_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DataTree_ESTest_3min_scaffolding.class.getClassLoader()); 
