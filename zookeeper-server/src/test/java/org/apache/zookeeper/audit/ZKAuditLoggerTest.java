...
public class ZKAuditLoggerTest extends QuorumPeerTestBase {
    ...
    private String getStartLog() {
        ...
        AuditEvent logEvent = ZKAuditLogger.createLogEvent(ZKAuditLogger.getZKUser(),
                AuditConstants.OP_START, AuditConstants.SUCCESS);
    ...
    private String getAuditLog(String operation, String znode, String status,
        ...
        AuditEvent logEvent = ZKAuditLogger.createLogEvent(user, operation, znode, acl, createMode, session, ip,
                status);
