...
public class PathTrieZeroShotRun10Test {
    ...
    @Test
    public void testAddPath_WhitespaceComponentFilteredOut() {
        pathTrie.addPath("/a/ /b");
    ...
    @Test
    public void testExistsNode_ConsecutiveSlashes_Normalized() {
        pathTrie.addPath("/a/b");
        assertTrue(pathTrie.existsNode("//a///b"));
    }
    ...
    public void testDeletePath_RootPath_ThrowsNullPointerException() {
        pathTrie.addPath("/");
        // Implementation edge case: current logic attempts to delete from parent, but root's parent is null
    ...
    @Test
    public void testDeletePath_TrailingSlash_Normalized() {
        pathTrie.addPath("/a/b");
        pathTrie.deletePath("/a/b/");
        assertFalse(pathTrie.existsNode("/a/b"));
    }
    ...
    public void testFindMaxPrefix_EmptyPath_ReturnsRoot() {
        assertEquals("/", pathTrie.findMaxPrefix(""), "Empty path skips split logic and returns root");
    }
