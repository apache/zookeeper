...
public interface Command {
    ...
    /**
     * Run this command. Commands take a ZooKeeperServer, String-valued keyword arguments,
     * nullable InputStream and return a CommandResponse object containing any information
     ...
     * @param inputStream InputStream from request (maybe null)
     ...
     */
    CommandResponse run(ZooKeeperServer zkServer, Map<String, String> kwargs, InputStream inputStream);
}
