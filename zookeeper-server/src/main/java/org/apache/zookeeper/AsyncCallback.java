...
public interface AsyncCallback {
    ...
    interface StatCallback extends AsyncCallback {
         ...
         * @see ZooKeeper#exists(String, Watcher, org.apache.zookeeper.AsyncCallback.StatCallback, Object)
         * @see ZooKeeper#setData(String, byte[], int, org.apache.zookeeper.AsyncCallback.StatCallback, Object)
         * @see ZooKeeper#setACL(String, List, int, org.apache.zookeeper.AsyncCallback.StatCallback, Object)
         */
    ...
    interface AllChildrenNumberCallback extends AsyncCallback {
         ...
         *
         * @see ZooKeeper#getAllChildrenNumber(String, org.apache.zookeeper.AsyncCallback.AllChildrenNumberCallback, Object)
         */
    ...
    interface DataCallback extends AsyncCallback {
         ...
         * @param stat {@link Stat} object of the node on given path.
         *
         * @see ZooKeeper#getData(String, boolean, org.apache.zookeeper.AsyncCallback.DataCallback, Object)
         * @see ZooKeeper#getData(String, Watcher, org.apache.zookeeper.AsyncCallback.DataCallback, Object)
         * @see ZooKeeper#getConfig(boolean, org.apache.zookeeper.AsyncCallback.DataCallback, Object)
         * @see ZooKeeper#getConfig(Watcher, org.apache.zookeeper.AsyncCallback.DataCallback, Object)
         */
    ...
    interface ACLCallback extends AsyncCallback {
         ...
         * @param stat {@link Stat} object of the node on given path.
         *
         * @see ZooKeeper#getACL(String, Stat, org.apache.zookeeper.AsyncCallback.ACLCallback, Object)
         */
    ...
    interface ChildrenCallback extends AsyncCallback {
         ...
         *
         * @see ZooKeeper#getChildren(String, boolean, org.apache.zookeeper.AsyncCallback.ChildrenCallback, Object)
         * @see ZooKeeper#getChildren(String, Watcher, org.apache.zookeeper.AsyncCallback.ChildrenCallback, Object)
         */
    ...
    interface Children2Callback extends AsyncCallback {
         ...
         * @see ZooKeeper#getChildren(String, boolean, org.apache.zookeeper.AsyncCallback.Children2Callback, Object)
         * @see ZooKeeper#getChildren(String, Watcher, org.apache.zookeeper.AsyncCallback.Children2Callback, Object)
         */
    ...
    interface Create2Callback extends AsyncCallback {
         ...
         *
         * @see StringCallback
         * @see ZooKeeper#create(String, byte[], List, CreateMode, org.apache.zookeeper.AsyncCallback.Create2Callback, Object)
         * @see ZooKeeper#create(String, byte[], List, CreateMode, org.apache.zookeeper.AsyncCallback.Create2Callback, Object, long)
         */
    ...
    interface StringCallback extends AsyncCallback {
         ...
         *             been created.
         *
         * @see ZooKeeper#create(String, byte[], List, CreateMode, org.apache.zookeeper.AsyncCallback.StringCallback, Object)
         */
     ...
     * that doesn't want anything sent back, e.g. {@link ZooKeeper#sync(String, org.apache.zookeeper.AsyncCallback.VoidCallback, Object)}.
     */
    @InterfaceAudience.Public
    interface VoidCallback extends AsyncCallback {
         ...
         *             {@link ZooKeeper#delete(String, int, org.apache.zookeeper.AsyncCallback.VoidCallback, Object)}.</li>
         * </ul>
         *
         * @param rc   The return code or the result of the call.
         * @param path The path that we passed to asynchronous calls.
         * @param ctx  Whatever context object that we passed to asynchronous calls.
         *
         * @see ZooKeeper#delete(String, int, org.apache.zookeeper.AsyncCallback.VoidCallback, Object)
         * @see ZooKeeper#removeAllWatches(String, Watcher.WatcherType, boolean, org.apache.zookeeper.AsyncCallback.VoidCallback, Object)
         * @see ZooKeeper#removeWatches(String, Watcher, Watcher.WatcherType, boolean, org.apache.zookeeper.AsyncCallback.VoidCallback, Object)
         * @see ZooKeeper#sync(String, org.apache.zookeeper.AsyncCallback.VoidCallback, Object)
         *
         */
    ...
    interface MultiCallback extends AsyncCallback {
         ...
         *
         * @see ZooKeeper#multi(Iterable, org.apache.zookeeper.AsyncCallback.MultiCallback, Object)
         */
     ...
     *
     * @see ZooKeeper#getEphemerals(org.apache.zookeeper.AsyncCallback.EphemeralsCallback, Object)
     * @see ZooKeeper#getEphemerals(String, org.apache.zookeeper.AsyncCallback.EphemeralsCallback, Object)
     *
     * @since 3.6.0
     */
