...
import org.apache.zookeeper.backup.BackupUtil.BackupFileType;
import org.apache.zookeeper.backup.BackupUtil.ZxidPart;
...
public class BackupFileInfo {
  ...
  public BackupFileInfo(File backedupFile, long modificationTime, long size) {
    ...
    this.zxidRange =
        BackupUtil.getZxidRangeFromName(backedupFilename, BackupFileType.toPrefix(this.fileType));
  }
  ...
  public long getZxid(ZxidPart whichZxid) {
    return whichZxid == ZxidPart.MIN_ZXID ? this.zxidRange.lowerEndpoint()
