...
public class ZKClientConfig extends ZKConfig {
  ...
  /**
   * This controls whether automatic watch resetting is enabled. Clients automatically reset watches
   * during session reconnect, this option allows the client to turn off this behavior by setting
   * the property "zookeeper.disableAutoWatchReset" to "true"
   */
  ...
  /**
   * Initialize all the ZooKeeper client properties which are configurable as java system property.
   */
  ...
  protected void handleBackwardCompatibility() {
    /** backward compatibility for properties which are common to both client and server */
  ...
  /**
   * Get the value of the <code>key</code> property as an <code>long</code>. If property is not set,
   * the provided <code>defaultValue</code> is returned
   *
   * @param key property key.
   * @param defaultValue default value.
   * @return return property value as an <code>long</code>, or <code>defaultValue</code>
