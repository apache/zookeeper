...
public class FourLetterWordMain {
   ...
   * @throws java.io.IOException IOException while executing four letter word
   * @throws SSLContextException SSLContextException while getDefaultSSLContext
   */
  ...
  public static String send4LetterWord(
      String host, int port, String cmd, boolean secure, int timeout)
      throws IOException, SSLContextException {
  ...
  /**
     * main method to run the FourLetterWordMain.
  ...
  public static void main(String[] args) throws IOException, SSLContextException {
    if (args.length == 3) {
      ...
      System.out.println(
          send4LetterWord(
              args[0], Integer.parseInt(args[1]), args[2], Boolean.parseBoolean(args[3])));
    } else {
