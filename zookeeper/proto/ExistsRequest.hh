...
#ifndef ExistsRequest_HH_
#define ExistsRequest_HH_
...
class ExistsRequest: public ERecord {
public:
	EString path;
	boolean watch;
	...
	ExistsRequest(EString path, boolean watch) {
		this->path = path;
		this->watch = watch;
	}
	EString getPath() {
	...
	virtual int compareTo(EObject* peer_) THROWS(EClassCastException) {
		ExistsRequest* peer = dynamic_cast<ExistsRequest*>(peer_);
		if (!peer) {
