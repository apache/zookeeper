...
#ifndef GetDataRequest_HH_
#define GetDataRequest_HH_
...
class GetDataRequest: public ERecord {
public:
	EString path;
	boolean watch;
	...
	GetDataRequest(EString path, boolean watch) {
		this->path = path;
		this->watch = watch;
	}
	EString getPath() {
	...
	virtual int compareTo(EObject* peer_) THROWS(EClassCastException) {
		GetDataRequest* peer = dynamic_cast<GetDataRequest*>(peer_);
		if (!peer) {
